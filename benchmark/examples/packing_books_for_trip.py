...
def packing_books_for_trip(scene_model, headless=False):
    """
    (:goal 
        (and 
            (forall 
    ...
    video_recorder.set(camera=og.sim.viewer_camera, robot = robot, save_path=f"{og.root_path}/../../images/packing_books_for_trip", name="packing_books_for_trip", trav_map_img=trav_map_img)
...
def main(random_selection=False, headless=False, short_exec=False):
    ...
    cfg["task"]["activity_name"] = "packing_books_for_trip"
    ...
    packing_books_for_trip(cfg["scene"]["scene_model"])
